...
echo ""
echo "📋 Next steps:"
echo "1. Edit //root/insight_aura/.env with your configuration"
...
echo "4. Start services: cd /root/insight_aura && docker-compose up -d"
...
echo "  - VPS_PROJECT_PATH: /root/insight_aura"
echo ""
